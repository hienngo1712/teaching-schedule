...
import { Receipt, Info, Wallet, Calculator } from "lucide-react"
...
export function TuitionDetailSheet({ open, onOpenChange, data, onSuccess }: TuitionDetailSheetProps) {
        ...
        <div className="space-y-3">
          ...
          <div className="bg-slate-50 rounded-xl border border-slate-100 p-4 space-y-3">
            <div className="flex justify-between items-center text-sm">
              ...
              <span className={cn(
                "font-medium",
                data.previousBalance > 0 ? "text-red-600" : data.previousBalance < 0 ? "text-green-600" : "text-slate-400"
              )}>
  ...
  const footer = (
    <div className="p-6 border-t bg-white space-y-4">
      {/* Tips/Info moved here, above button */}
